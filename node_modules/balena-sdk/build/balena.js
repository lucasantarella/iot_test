 ...
 */
var BALENA_SDK_HAS_SET_SHARED_OPTIONS, BALENA_SDK_HAS_USED_SHARED_OPTIONS, BALENA_SDK_SHARED_OPTIONS, BalenaAuth, assign, defaults, deprecationWarnings, errors, getPine, getRequest, getSdk, globalEnv, mapValues, notImplemented, ref, sdkTemplate;
...
ref = require('./util'), notImplemented = ref.notImplemented, globalEnv = ref.globalEnv;
...
getSdk = function(opts) {
  var auth, deps, pine, request, sdk, settings;
  if (opts == null) {
    opts = {};
  }
  defaults(opts, {
...
getSdk.setSharedOptions = function(opts) {
  ...
  return globalEnv[BALENA_SDK_HAS_SET_SHARED_OPTIONS] = true;
};
