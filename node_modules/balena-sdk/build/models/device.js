...
getDeviceModel = function(deps, opts) {
  ...
  /**
  	 ...
  	 * });
   */
  exports.isTrackingApplicationRelease = function(uuidOrId, callback) {
    return exports.get(uuidOrId, {
      $select: 'should_be_running__release'
    }).then(function(arg) {
      var should_be_running__release;
      should_be_running__release = arg.should_be_running__release;
  ...
  /**
  	 ...
  	 * });
   */
  exports.getTargetReleaseHash = function(uuidOrId, callback) {
    return exports.get(uuidOrId, {
      $select: 'id',
      $expand: {
      ...
      var belongs_to__application, should_be_running__release;
      should_be_running__release = arg.should_be_running__release, belongs_to__application = arg.belongs_to__application;
      if (!isEmpty(should_be_running__release)) {
  ...
  /**
  	 ...
  	 * });
   */
  exports.pinToRelease = function(uuidOrId, fullReleaseHashOrId, callback) {
    return Promise["try"](function() {
      var obj, releaseFilterProperty;
      ...
      releaseFilterProperty = isId(fullReleaseHashOrId) ? 'id' : 'commit';
      return exports.get(uuidOrId, {
        $select: 'id',
        $expand: {
          belongs_to__application: {
            ...
            $expand: {
              owns__release: {
                ...
                $filter: (
                  obj = {},
                  obj["" + releaseFilterProperty] = fullReleaseHashOrId,
                  obj.status = 'success',
                  obj
                ),
        ...
        var app, belongs_to__application, id, release;
        id = arg.id, belongs_to__application = arg.belongs_to__application;
      ...
      var deviceId, releaseId;
      deviceId = arg.deviceId, releaseId = arg.releaseId;
      return pine.patch({
        resource: 'device',
        id: deviceId,
        body: {
  ...
  /**
  	 ...
  	 * });
   */
  exports.trackApplicationRelease = function(uuidOrId, callback) {
    return getId(uuidOrId).then(function(deviceId) {
      return pine.patch({
        resource: 'device',
        id: deviceId,
