 ...
 */
var Promise, errors, findCallback, getReleaseModel, mergePineOptions, omit, once, ref;
...
getReleaseModel = function(deps, opts) {
  var applicationModel, buildDependentResource, exports, pine, tagsModel;
  pine = deps.pine;
  ...
  /**
  	 ...
  	 * });
   */
  exports.getWithImageDetails = function(id, options, callback) {
    if (options == null) {
      options = {};
    }
    callback = findCallback(arguments);
    ...
    }, options.release)).then(function(rawRelease) {
      var images, release;
      release = omit(rawRelease, ['contains__image', 'is_created_by__user']);
      images = rawRelease.contains__image.map(function(imageJoin) {
        return imageJoin.image[0];
      });
      release.images = images.map(function(imageData) {
        var image;
  ...
  /**
  	 ...
  	 * });
   */
  exports.getLatestByApplication = function(nameOrId, options, callback) {
    if (options == null) {
      options = {};
    }
    callback = findCallback(arguments);
    return exports.getAllByApplication(nameOrId, mergePineOptions({
      $top: 1,
      $filter: {
        status: 'success'
      }
    }, options)).get(0).asCallback(callback);
  };
  ...
  /**
  	 ...
  	 * });
   */
  exports.tags.getAllByApplication = function(nameOrId, options, callback) {
    if (options == null) {
      options = {};
    }
    return applicationModel().get(nameOrId, {
  ...
  /**
  	 ...
  	 * });
   */
  exports.tags.getAllByRelease = function(id, options, callback) {
    if (options == null) {
      options = {};
    }
    callback = findCallback(arguments);
