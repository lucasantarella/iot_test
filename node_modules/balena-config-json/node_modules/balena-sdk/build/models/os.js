 ...
 */
var BALENAOS_VERSION_REGEX, Promise, _, deviceTypesUtil, errors, findCallback, getImgMakerHelper, getOsModel, isDevelopmentVersion, notFoundResponse, once, onlyIf, osVersionRCompare, partition, ref, reject, semver, treatAsMissingApplication;
...
getOsModel = function(deps, opts) {
  ...
  exports._getMaxSatisfyingVersion = function(versionOrRange, osVersions) {
    var maxVersion, semverVersionOrRange, semverVersions;
  ...
  exports.getConfig = function(nameOrId, options, callback) {
    ...
    return Promise["try"](function() {
      ...
      }).get('body')["catch"](notFoundResponse, treatAsMissingApplication(nameOrId));
    }).asCallback(callback);
  };
  return exports;
};
